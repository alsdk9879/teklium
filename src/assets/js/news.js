...
export let releases = ref(JSON.parse(sessionStorage.getItem('releases')) || {});
export let endOfList = ref(JSON.parse(sessionStorage.getItem('endOfList')));
export let fetching = ref(false);

// onMounted(() => {
//     releases.value = JSON.parse(sessionStorage.getItem('releases'));
// })
