...
section.dark(style="padding-top: 12rem")
    .inner
        //- h1(style="font-size: 3.5rem; margin-bottom:0") {{ params[route.path.split('/')[2]].tit }}
...
section.white 
    ...
    .inner
        //- .image
        //-     img(:src="'/src/assets/img/' + params[route.path.split('/')[2]].img")

        //- br
        //- br

        //- div(v-html="params[route.path.split('/')[2]].cont")
...
//         img: 'carbon.webp',
//         cont: `<strong class="sky">Today's Challenge</strong>
